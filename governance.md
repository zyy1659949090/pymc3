...
[ GitHub organization](https://github.com/ipython) and the
[PyMC3 GitHub organization](https://github.com/jupyteri). Examples of
Project Software include the  Notebook, the  Terminal,
.parallel, the PyMC3 Hub, etc. The Services run by the
...
Project Services include the PyMC3 and  websites
...
PyMC3/ umbrella and cannot use the Project trademarks in a way that
...
-   Acknowledged on the PyMC3/ websites, in talks and T-shirts.
-   Ability to acknowledge their own funding sources on the PyMC3/
    websites, in talks and T-shirts.
-   Unlimited participation in the annual Institutional Partners Workshop, held
    during the (planned) annual PyMC3 Project Retreat. This allows the
...
-   Ability to influence the project through the participation of their Council
    Member.
-   Council Members are invited to the bi-annual PyMC3/ Developer Meeting.
...
-   Only Institutional Contributors are invited to the Institutional Partners
    Workshop and bi-annual PyMC3 Developer Meeting
